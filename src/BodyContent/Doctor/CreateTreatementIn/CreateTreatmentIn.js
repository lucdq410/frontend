...
function CreateTreatmentIn() {
  ...
  const handleConfirmationCompleteConfirm = async () => {
    try {
      ...
      await axios.post('https://qqqq-v7b6.onrender.com/api/treatmentin/create', treatmentInData);
      await axios.post(`https://qqqq-v7b6.onrender.com/api/appointment/update?id=${idslot}`, { status: 'Done' });
